...
public class MainActivity extends AppCompatActivity {
    ...
    private FirebaseAuth mAuth; //for authorization
    private FirebaseAuth.AuthStateListener mAuthListener; //authorization listener
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAuth = FirebaseAuth.getInstance(); //initilizezed

        mAuthListener = new FirebaseAuth.AuthStateListener() { //authorization listener
            @Override
    ...
    @Override
    public void onStart() { //sets up the listner
        super.onStart();
        mAuth.addAuthStateListener(mAuthListener);
    }

    @Override
    public void onStop() { //stops the listener
        super.onStop();
